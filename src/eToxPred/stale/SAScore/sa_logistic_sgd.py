...
def load_data(dataset):
    ...
    valid_set = (my_x[train_len:train_len + vt_len], my_y[train_len:train_len + vt_len])
    test_set = (my_x[train_len + vt_len:-1], my_y[train_len + vt_len:-1])
    print ('Training set size', train_len)
    print ('Validation set size', vt_len)
    print ('Test set size', vt_len)
    print ('average SA training set: ' + repr(numpy.mean(train_set[1])))
    print ('average SA validation set: ' + repr(numpy.mean(valid_set[1])))
    print ('average SA test set: ' + repr(numpy.mean(test_set[1])))
